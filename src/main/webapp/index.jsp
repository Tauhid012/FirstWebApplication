...
<body>
	...
	<form action="signUp" method="POST"
		onsubmit="return validatePassword()" style="border: 1px solid #ccc">
		<div class="container">
			<h1>Sign Up</h1>
			...
			<label for="psw"><b>Password</b></label> <input type="password"
				...
				type="password" placeholder="Repeat Password" name="rpsw" id="rpsw"
			...
			<p>
				By creating an account you agree to our <a
					href="https://www.codeplanet.co.in/">Terms & Privacy</a>.
			</p>
